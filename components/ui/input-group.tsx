...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      // This wrapper groups multiple controls without fieldset form semantics.
...
function InputGroupAddon({
  ...
  return (
    // Clicking the decorative addon only extends the adjacent input's pointer
    // hit target; the input itself remains the keyboard-accessible control.
    // oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions
    <div
      // Nested addon content is a control group, not a form fieldset.
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role
      role="group"
